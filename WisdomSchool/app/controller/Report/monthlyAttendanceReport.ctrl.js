(function () {
    'use strict';
    var controllerId = 'MonthlyAttendanceReportCtrl';
    ...
    var myApp = angular.module('AngularApp').controller(controllerId,
        ['$scope',
         ...
         '$location',
          MonthlyAttendanceReportCtrlFn
        ]);

    function MonthlyAttendanceReportCtrlFn($scope, ReportSrvc, Excel, $timeout, StudentDetailservice,ClassService, $location) {
        ...
        ReportSrvc.getMonthlyAttendance(successCallBack, failureCallBack);
